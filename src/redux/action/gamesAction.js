...
export const listeCalendar = () => async (dispatch) => {
    try {
      ...
      const response = await axios.get(`https://basketball-demo.netlify.app/api/v1/games/calendar`);
...
export const listeRanking = () => async (dispatch) => {
  try {
    ...
    const response = await axios.get(`https://basketball-demo.netlify.app/api/v1/games/ranking`);
