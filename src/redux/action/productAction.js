...
export const createProduct = (params) => async (dispatch,getState) => {
  try {
    ...
    const response = await axios.post('https://basket-demo2-website-api.onrender.com/api/v1/products/create-product', params, config);
...
export const produitDetail = (id)  => async (dispatch,getState) => {
    try {
        ...
        const response = await axios.get(`https://basket-demo2-website-api.onrender.com/api/v1/products/${id}`)
        // Success, return data into action.payload
        dispatch({
...
export const userProductStatus = (params) => async (dispatch,getState) => {
  try {
    ...
    const response = await axios.get('https://basket-demo2-website-api.onrender.com/api/v1/products/all-user-product-status', config);
...
export const getRelatedProducts = (productId) => async (dispatch) => {
  try {
      ...
      const response = await axios.get(`https://basket-demo2-website-api.onrender.com/api/v1/products/${productId}/related`);
